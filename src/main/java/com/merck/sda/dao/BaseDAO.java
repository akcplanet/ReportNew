...
import com.merck.sda.domain.Count;
import com.merck.sda.exception.DAOException;
import com.merck.sda.exception.ErrorCode;
...
public class BaseDAO {
	...
	@PersistenceContext(unitName = "SDADB")
